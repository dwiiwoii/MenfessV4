...
break
case 'instagram':{
if (!q) return reply('contoh :\n#instagram https://www.instagram.com/reel/CnJuvOio2vq/?igshid=YmMyMTA2M2Y=')
reply(mess.wait)
fetchJson(`https://saipulanuar.ga/api/downloader/instagram?url=https://www.instagram.com/p/CNtpwxuH5NK/?igshid=g26k5coikzwr`)
.then(tt_res => {
reply(`INSTAGRAM 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗
...
break
case 'video':{
if (!q) return reply('contoh :\n#video https://www.instagram.com/reel/CnJuvOio2vq/?igshid=YmMyMTA2M2Y=')
reply(mess.wait)
fetchJson(`https://saipulanuar.ga/api/downloader/allvideo?url=https://www.instagram.com/p/CNtpwxuH5NK/?igshid=g26k5coikzwr`)
.then(tt_res => {
reply(`ALL VIDEO 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗ER
